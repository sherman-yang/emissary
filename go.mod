...
// controller-gen.
replace k8s.io/code-generator v0.30.2 => github.com/emissary-ingress/code-generator v0.30.2-0.20250205230848-daa3b0f955a4
...
require (
	...
	github.com/emissary-ingress/goversion v0.0.0-20230221050731-229c429afb59
